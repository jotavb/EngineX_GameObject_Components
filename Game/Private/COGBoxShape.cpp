...
{
	exVector2 p1 { mTransform->Position().x - mWidth / 2, mTransform->Position().y + mHeight / 2 };
	exVector2 p2 { mTransform->Position().x + mWidth / 2, mTransform->Position().y - mHeight / 2 };
